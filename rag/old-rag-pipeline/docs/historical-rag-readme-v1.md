# Historical RAG README v1.0.0 — Preserved Snapshot

## Table of Contents

- [Snapshot Metadata](#snapshot-metadata)
- [Preserved Original v1.0.0 Content](#preserved-original-v100-content)
- [Related Documentation](#related-documentation)

<a id="snapshot-metadata"></a>
## Snapshot Metadata

This file preserves the complete **83,762-byte** RAG README that existed before the Pinecone provider was selected, the Pinecone index was populated/validated, and the Python retrieval runtime was locally exercised. It is retained so the documentation overhaul does not delete or silently rewrite development history.

Historical identity embedded in the original document:

- File ID: `RAG-README-80e1e56c-9003-4999-8d25-262cbefb9998`
- Version ID: `RAG-README-v1.0.0-338f17e0-0e30-4ab8-83a6-e0b78cafe75e`
- SHA-256: `e181496299ac8528e39027d3d915a6568f02e784d2a50cdbb342e3ec54e161b5`

**Status warning:** statements such as “vector database provider not yet selected” are true for this historical snapshot and are intentionally preserved as history. For current truth use [`../README.md`](../README.md) and [`../runtime/README.md`](../runtime/README.md).

<a id="preserved-original-v100-content"></a>
## Preserved Original v1.0.0 Content

The content below is the complete previous README, retained verbatim after this preservation wrapper.
...
- Parent/current RAG source of truth: [`../README.md`](../README.md)
- [RAG evolution history](retrieval-version-history.md)
- [Pinecone current state](pinecone.md)
- [Runtime current state](../runtime/README.md)
- [Whole-project version map](../../docs/versions/component-version-map.md)
