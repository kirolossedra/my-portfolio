...
```text
rag-next-pipeline/03-embeddings/output/embeddings-cloudflare-v1/
...
```text
rag-next-pipeline/docs/reference-output/vectorize-cloudflare-v1/vectorize-dense-parity-validation-v1.json
rag-next-pipeline/docs/reference-output/vectorize-cloudflare-v1/vectorize-dense-parity-validation-v1.txt
```
