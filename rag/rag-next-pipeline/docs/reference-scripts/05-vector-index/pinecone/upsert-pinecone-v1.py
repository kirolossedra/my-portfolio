...
This script is location-independent within rag-next-pipeline/. It discovers the
...
OUTPUT
------
docs/reference-output/pinecone-v1/pinecone-upsert-validation-v1.json
...
EMBEDDINGS_PATH = PROJECT_ROOT / "03-embeddings" / "output" / "embeddings-v2" / "embeddings.npy"
EMBEDDING_RECORDS_PATH = (
    PROJECT_ROOT / "03-embeddings" / "output" / "embeddings-v2" / "embedding-records.jsonl"
)
DOCUMENTS_PATH = (
    PROJECT_ROOT / "02-retrieval-documents" / "output" / "documents.jsonl"
)
OUTPUT_DIR = PROJECT_ROOT / "docs" / "reference-output" / "pinecone-v1"
