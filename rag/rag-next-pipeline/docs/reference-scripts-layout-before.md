...
```text
python rag-next-pipeline/01-corpus/scripts/prepare-rag-corpus.py
  -> python rag-next-pipeline/02-retrieval-documents/scripts/build-rag-retrieval-documents-v2.py
  -> python rag-next-pipeline/03-embeddings/scripts/nomic/generate-rag-embeddings-v3-documents-local.py
  -> python rag-next-pipeline/docs/reference-scripts/04-retrieval-reference/build-rag-retrieval-v3-evidence-aware-local.py
  -> python rag-next-pipeline/docs/reference-scripts/05-vector-index/pinecone/upsert-pinecone-v1.py
  -> python rag-next-pipeline/docs/reference-scripts/06-validation/pinecone/validate-pinecone-dense-parity-v2.py
```
...
```text
node rag-next-pipeline/03-embeddings/scripts/cloudflare/generate-rag-embeddings-v4-cloudflare.mjs
  -> 03-embeddings/output/embeddings-cloudflare-v1/
  -> node rag-next-pipeline/docs/reference-scripts/05-vector-index/cloudflare-vectorize/publish-vectorize-v1.mjs
  -> portfolio-career-rag-cloudflare-v1
  -> node rag-next-pipeline/docs/reference-scripts/06-validation/cloudflare-vectorize/validate-vectorize-dense-parity-v1.mjs
```

## Stage 01 — Corpus

Converts the repository-analysis Markdown source batches into the canonical normalized corpus under `01-corpus/output/`.
...
Current active output: `02-retrieval-documents/output/`.
...
- Implemented candidate v4/Cloudflare: Workers AI `@cf/qwen/qwen3-embedding-0.6b` over the same 2,808 evidence-aware documents, producing 1,024-D vectors under `03-embeddings/output/embeddings-cloudflare-v1/`.
...
Stage 03 now contains the implemented Cloudflare Workers AI v4 candidate at `03-embeddings/cloudflare/generate-rag-embeddings-v4-cloudflare.mjs`. It writes `03-embeddings/output/embeddings-cloudflare-v1/` in parallel with the validated Nomic artifacts.

## Path Resolution Contract

All executable scripts in this tree resolve paths from the enclosing `rag/` directory rather than assuming that `01-corpus/output/` is beside the script.
...
RAG_ROOT = .../rag
             ↓
corpus I/O = RAG_ROOT / 01-corpus/output / ...
```
...
```text
rag-next-pipeline/03-embeddings/output/embeddings-v2/
