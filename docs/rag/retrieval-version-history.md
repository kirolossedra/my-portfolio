...
The complete pre-Pinecone/pre-runtime snapshot remains preserved in the untouched implementation-adjacent history file at `rag/docs/historical-rag-readme-v1.md`. It is historical provenance, not current RAG documentation truth.
